...
const ConstantStaking30 = initConstantStaking({
  ...
  expiration_time: "25 January 2022",
});
const ConstantStaking60 = initConstantStaking({
...
const ConstantStaking120 = initConstantStaking({
...
const Staking3 = initStaking({
  ...
  expiration_time: "16 December 2021",
});
...
const StakingUsdt3 = initStaking({
  token: window.token_usdt_3,
  staking: window.staking_usdt_3,
  liquidity: usdt_address,
  lp_symbol: "DYP/USDT",
  reward: "30,000",
  lock: "3 Days",
  rebase_factor: rebase_factors[12],
  expiration_time: "16 December 2021",
});
const StakingUsdt30 = initStaking({
  token: window.token_usdt_30,
  staking: window.staking_usdt_30,
  liquidity: usdt_address,
  lp_symbol: "DYP/USDT",
  reward: "45,000",
  lock: "30 Days",
  rebase_factor: rebase_factors[13],
  expiration_time: "16 December 2021",
});
const StakingUsdt60 = initStaking({
  token: window.token_usdt_60,
  staking: window.staking_usdt_60,
  liquidity: usdt_address,
  lp_symbol: "DYP/USDT",
  reward: "75,000",
  lock: "60 Days",
  rebase_factor: rebase_factors[14],
  expiration_time: "16 December 2021",
});
const StakingUsdt90 = initStaking({
  token: window.token_usdt_90,
  staking: window.staking_usdt_90,
  liquidity: usdt_address,
  lp_symbol: "DYP/USDT",
  reward: "100,000",
  lock: "90 Days",
  rebase_factor: rebase_factors[15],
  expiration_time: "16 December 2021",
});
...
const ConstantStaking2 = initConstantStakingNew({
...
const Vesting = initVesting({
  staking: window.constant_staking_200,
  buyers: true,
  apr: 0,
  liquidity: eth_address2,
  expiration_time: "16 February 2022",
});
const VestingStaking = initVestingStaking({
  staking: window.constant_staking_300,
  apr: 0,
  liquidity: eth_address2,
  expiration_time: "16 February 2022",
});
