    ...
    class Staking extends React.Component {
        ...
        refreshBalance = async () => {
            ...
            try {
                ...
                let [token_balance, pendingDivs, totalEarnedTokens, stakingTime,
                    ...
                    //constant staking
                    pendingDivsConstant, token_dyp_balance, tvlConstant, tvlConstantiDYP, totalEarnedTokensConstant, depositedTokensBuyback, tvlDYPS
                ...
                tvl = new BigNumber(tvl).plus(tvlValue).plus(tvlValueiDYP).plus(usdValueDYPS).toFixed(18)
        ...
        render() {
            ...
            return (<div>
                    ...
                    <div className='row'>
                        <div className="col-12" style={{background: 'url(img/banner/dyp_buyback_desk-12.svg)', backgroundSize: 'cover', resize: 'both'}}>
                                    ...
                                    <div className='col-6' style={{marginBottom: '27px'}}>
                                        <div className='row'>
                                            ...
                                            <div style={{paddingLeft: '20px'}} className='col-6'>
                                                <button className onClick={()=> window.open("https://www.youtube.com/watch?v=7CZ_ianX2bk", "_blank")}
