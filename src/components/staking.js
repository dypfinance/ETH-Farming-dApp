                                                ...
                                                <div className='row'>
                                                    ...
                                                    <div className='col-4'>
                                                        <a target='_blank' rel='noopener noreferrer'
                                                           href={`https://app.uniswap.org/#/add/v2/0x961C8c0B1aaD0c0b10a51FeF6a867E3091BCef17/${liquidity}`}>
                                                            <button
                                    ...
                                    <div className='form-group'>
                                        ...
                                        <div className='form-row'>
                                            <div className='col-md-6'>
                                                <p className='form-control  text-right' style={{border: 'none', marginBottom: 0, paddingLeft: 0,  background: 'transparent', color: 'var(--text-color)'}}><span style={{fontSize: '1.2rem', color: 'var(--text-color)'}}>{pendingDivsEth}</span> <small className='text-bold'>WETH</small></p>
                                            </div>
                                            <div className='col-md-6'>
