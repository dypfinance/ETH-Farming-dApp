    ...
    class Staking extends React.Component {
        ...
        refreshBalance = async () => {
            ...
            try {
                ...
                ] = await Promise.all([_bal, _pDivs, _tEarned, _stakingTime, _dTokens, _lClaimTime, _tvl, _rFeeEarned, tStakers, _tvlConstantDAI, _tvlDYPS])
                ...
                let tvlUSD = new BigNumber(tvl).times(usd_per_lp).plus(usdValueDAI).plus(usdValueDYPS).toFixed(18)
                //console.log({tvlUSD})
                                ...
                                <div className='col-7 col-md-7 col-lg-6 col-xl-5'>
                                    <div className='row'>
                                        ...
                                        <div className='col-11 col-md-5 mb-4'>
                                            <button className onClick={()=> window.open("https://www.youtube.com/watch?v=D5g19SuQlcI&t=2s", "_blank")}
                                                    ...
                                                    <div className='form-group'>
                                                        ...
                                                        <p className='form-control  text-right' style={{ border: 'none', marginBottom: 0, paddingLeft: 0, background: 'transparent', color: '#222' }}><span style={{ fontSize: '1.2rem', color: 'rgb(255, 0, 122)' }}>{pendingDivsEth}</span> <small className='text-bold'>WETH</small></p>
                                                            ...
                                                            <div className='col-md-12'>
                                                                ...
                                                                <input value={Number(pendingDivs) > 0 ? `${pendingDivs} WETH` : `${pendingDivs} WETH`} onChange={e => this.setState({pendingDivs: Number(e.target.value) > 0 ? e.target.value : e.target.value})} className='form-control left-radius' placeholder='0' type='text' disabled />
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div className='form-row'>
                                    ...
                                    <div className='l-box'>
                                        ...
                                        <td className="text-right"><strong>{pendingDivs}</strong> <small>DYP</small></td>
                                                ...
                                                {is_connected ?
                                                    ...
                                                    <tr>
                                                        <td style={{fontSize: '1rem', paddingTop: '2rem'}} colSpan='2'
                                                            className='text-center'>
                                                            <a target='_blank' rel='noopener noreferrer'
                                                               href={`${window.config.etherscan_baseURL}/token/${reward_token._address}?a=${coinbase}`}>View
                                                                Transaction History on Etherscan</a> &nbsp; <i
                                                            style={{fontSize: '.8rem'}}
